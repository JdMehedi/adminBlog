...
func (c *categoryServiceClient) CompleteCategory(ctx context.Context, in *CompleteCategoryRequest, opts ...grpc.CallOption) (*CompleteCategoryResponse, error) {
	out := new(CompleteCategoryResponse)
	err := c.cc.Invoke(ctx, "/category.CategoryService/CompleteCategory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CategoryService_CompleteCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompleteCategoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CategoryServiceServer).CompleteCategory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/category.CategoryService/CompleteCategory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).CompleteCategory(ctx, req.(*CompleteCategoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "blog/gunk/v1/category/all.proto",
}
